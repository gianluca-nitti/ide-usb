...
/**
  ...
  * @retval None
  */
static void USBD_static_free(void *p)
{
...
uint8_t USBD_MSC_Init(USBD_HandleTypeDef *pdev, uint8_t cfgidx)
{
  ...
  hmsc = (USBD_MSC_BOT_HandleTypeDef *)USBD_static_malloc(sizeof(USBD_MSC_BOT_HandleTypeDef));
...
uint8_t USBD_MSC_DeInit(USBD_HandleTypeDef *pdev, uint8_t cfgidx)
{
  ...
  if (pdev->pClassData != NULL)
  {
    ...
    (void)USBD_static_free(pdev->pClassData);
    pdev->pClassData = NULL;
  }
